	...
	TrustindexConnect = {
		...
		if (TrustindexConnect.button.length) {
			...
			TrustindexConnect.button.click(function(event) {
				...
				let regex = /tripadvisor\.([^\/]+)\/((?:Attraction_Review-|AttractionProductReview-|Restaurant_Review-|Airline_Review-|Hotel_Review-|VacationRentalReview-|Cruise_Review-)[^_-]+[^\#\?]+\.html)/i;
				...
				div.find('img').attr('src', 'https://cdn.trustindex.io/assets/platform/Tripadvisor/icon.png');
